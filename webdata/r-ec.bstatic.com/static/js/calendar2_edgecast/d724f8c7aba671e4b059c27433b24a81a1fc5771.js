...
},initMarkup:function(){var k=this.getOption_("title"),h=(this.options.closeButton)?'<div class="c2-calendar-close-button"><i class="c2-calendar-close-button-icon">×</i></div>':"";
var i="";
...
booking[sNSExperiments]["BOefGOaYddbYQLccOdNAUFEO"]=(function(c){var b="BOefGOaYddbYQLccOdNAUFEO";
function a(){c.eventEmitter.bind("CALENDAR:opened",function(){c.track.stage(b,1);
var d;
if(c.env&&c.env.b_action){switch(c.env.b_action){case"hotel":case"searchresults":case"book":c.track.stage(b,2);
break;
default:c.track.stage(b,3)
}}})
}return{init:function(){a();
c.eventEmitter.bind("CALENDAR:opened",function(f,g){var e=g.instance.$footer.find(".c2-calendar-footer__bpg");
var d='<div class="c2-calendar-footer__bpg">'+booking.jstmpl("bpg_module_clientside").render({b_is_tdot_traffic:!!booking.env.b_is_tdot_traffic,b_is_desktop_site:!booking.env.b_is_tdot_traffic})+"</div>";
if(!e.length){g.instance.$footer.addClass("c2-calendar-footer--bpg");
g.instance.$footer.html(g.instance.$footer.html()+d)
}})
},initElse:a}
})(booking);