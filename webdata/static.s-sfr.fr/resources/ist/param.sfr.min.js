sfrIstRegles=[["applis.sfr.pro",,1],["assistance@",,3],["(tv|club-video|bourse|elle|info|public|minutebuzz|sport|(achat-)?jeux-[^.]*|annuaires|meteo|astralia|rencontres|shopping|atelier|cartewifi|smartphones|espace-client|sfrlive)@",,4],["@/(espace-client|parcours(-securite)?)/|^newslettervod.contact-sfr.com",,4],["appliscope@","slim",4],["(m.)?groupe(numericable)?(.m)?@","groupe","G"],["(m.)?numericable-sfr.com","groupe","G"],["preprod-groupesfrfr.(m.)?wsfront-mic@","groupe","G"],["@/(suivi-commande|mobile/ma-commande)/|espace-client@/suivi-commande/|accessoires@/eshop/(login|mon-compte)",0,"S"],["boutique@|espace-sfr@|@/mobile/espacesfr/",0,"M"],["forum@",0,"F"],["@/preferer-sfr/|adsl@/couverture-geographique/",0,"R"],["@/cas/",,9],["messagerie[^.]*@",,"W","mail|contact|cloud"],["mes-contacts.services@",,"W","contact|mail|cloud"],["@/dropbox",,,"dropbox"],["@/(forfait-mobile(-fut)?/(configurateur/|recap/p|pnm|accessoires|options)|parcours/premiere-authent/|terminer-ma-commande/)|box@|(red)?@/offre-internet/[^/]+/personnalisez-votre-box.htm|telephone-occasion@/(mon-panier|information-client|paiement)","tunnel"],["box@/bolchange/offer-equipment(-v2)?.htm","home"],["(www.)sfr.odr.fr","home",,,,,,9],["m@/(contenu|votre-portail|info-loisirs|home/u)/|[^/]*[.]m@/",,,,"SFR &amp; Moi"],["m@/(m?boutique|mobile)/|(accessoires|recyclage-mobile)[.]m@/",,,,"Boutique"],["m@/home/home-espaces-sfr.html",,,,9],["m@/(home|contenu)/assistance/",,,,"Assistance"],["m@/(mon-compte|(contenu/)?espace-client|perso)/|espace-client[.]m@",,,,"SFR &amp; Moi > Espace Client"],["(groupe(numericable)?.m|m.groupenumericable)@/$",,,,"Groupe SFR"],["(groupe(numericable)?.m|m.groupenumericable)@/nous-connaitre/",,,,"Nous connaître"],["(groupe(numericable)?.m|m.groupenumericable)@/(presse/|tous-les-communiques)",,,,"Presse"],["(groupe(numericable)?.m|m.groupenumericable)@/carrieres/",,,,"Carrières"],["(groupe(numericable)?.m|m.groupenumericable)@/finance/",,,,"Finance"],["@/forfait-mobile(-fut)?/telephone/",,,,,location.search.match(/universe=RED/)?20104:20200],["@/forfait-mobile(-fut)?/telephones/forfait-sans-engagement",,,,,20104],["@/forfait-mobile(-fut)?/offres/forfait-mobile",,,,,20300],["@/forfait-mobile(-fut)?/offres/forfait-sans-engagement",,,,,20350],["@/(telephonie|forfait)-mobile(-fut)?/",,,,,,1],["@/box-internet|adsl@",,,,,,2],["boutique@(/?$|/[^0-9])",,,,,,3],[]];
...
}if(B(H,/sfr.fr.cas.logout/)){U=(Q?"cms":"www")+".sfr.fr/";K(this).attr("href","https://"+U+"cas/logout?url="+escape((I("messagerie.*@")?"https://"+U:R!="EC"?j():"https://"+(Z.isRED?(Q?"cms.":"")+"red.sfr.fr/":U))+"#sfrintid="+R+"_head_deco"));
...
while(d[0]&&!/U=SFR/.test(d[0])){d=d.slice(1);}}if(d&&B(d[0],/M=(THD|ADSL)\b/)&&!Z.isRED){K("header li[data-menu]>a").each(function(R,H){H=(R=K(this).html()).replace(/Fibre/,"Box");
...
T="@/forfait-mobile(-fut)?";d=I(d+"/offres")?2:I(d+"/telephones?")?3:I(d)?2:I(T+"/offres")?23:I(T+"/telephones?")?22:I(T)?2:I("@/offre-internet")?12:I("parrainage-red@")?5:I("assistance@")?0:I("(@/)?(mon-)?espace-client@?")?6:0;
if(d){F.set("subHeader",d);}if(E){F.set("title",E);}else{K("header h1").hide();}G.setInterval(function(){if(d=P("sfrUserInfos")){F.set("firstName",d);
...
}function a(H,R){H=K(".breadcrumbRN,ol.breadcrumb");R=B(P("eTmf"),/^([0-9]+)/);if(!H.length){G.setTimeout(a,330);
}else{if(C<3||R){H.prepend('<ul style="float:right"><li><a href="'+(C==1?"https://www.sfr.fr/telephonie-mobile/faq/":C==2?"https://adsl.sfr.fr/foire-aux-questions/":C==3?"https://boutique.sfr.fr/"+R[1]+'">Votre boutique préférée':"#")+(C<3?'">Questions/réponses':"")+"</a></li></ul>");
}}}if(C){a();}}};