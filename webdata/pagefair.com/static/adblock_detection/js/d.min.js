...
document.location.protocol?"https://":"https://",q=function(){var a=3,b=document.createElement("div"),c;do b.innerHTML="\x3c!--[if gt IE "+ ++a+"]><i></i><![endif]--\x3e",c=0<b.getElementsByTagName("i").length?!0:!1;while(c);return 4<a?a:void 0}(),k=u(window.navigator.userAgent),s=function(){var a={};jQuery.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(b,c){a["[object "+c+"]"]=c.toLowerCase()});return a}(),l=function(){request_params={};for(var a,b=window.location.href.slice(window.location.href.indexOf("?")+
...
typeof XMLHttpRequest&&"withCredentials"in new XMLHttpRequest&&n("1.5.2")){var f=!1,g={};g.url=a;g.type="GET";g.data=b;g.cache=!1;g.dataType="text";d&&(g.xhrFields={withCredentials:!0});null!=c&&(g.success=c);jQuery.ajax(g)}f&&(null!=c&&(d=("r"+p()).replace(".",""),b.cbfnc=d,window[d]=c),b._=p(),c=document.createElement("SCRIPT"),c.src=a+e(b),c.type="text/javascript",(document.head||document.getElementsByTagName("head")[0]).appendChild(c))},Z:function(){return window.location.href!=window.parent.location.href?
document.referrer:document.location.href},fa:function(){return document.referrer}}},{}],7:[function(h){var f=h("./lib/config-measuring"),e=h("./lib/detection")(f),n=h("./lib/reporting")(f),p=h("./lib/utils");n.N();e.O(!0,function(f,g,b,h){0.001>p.random()?e.D(function(d){n.t(f,g,b,h,d)}):n.t(f,g,b,h);"undefined"!==typeof pf_notify&&jQuery.isFunction(pf_notify)&&pf_notify(f,b)})},{"./lib/config-measuring":2,"./lib/detection":4,"./lib/reporting":5,"./lib/utils":6}]},{},[7]);
