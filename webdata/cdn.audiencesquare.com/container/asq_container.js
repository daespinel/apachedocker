...
if (script) {
	var qs = getUrlVars();
	var alephd_src = 
'https://pixel.alephd.com/post_asq?LgDc='+qs.v+'&L4DK='+qs.b+'&rZzC='+qs.c+'&aNVl='+qs.d+'&ZzpC='+qs.e+'&Dsph='+qs.f+'&Hsyz='+qs.g+'&0ZGY='+qs.h+'&Xyes='+qs.i+'&iK5S='+qs.j+'&b6lE='+qs.k+'&-tgi='+qs.l+'&wziz='+qs.m+'&vKcZ='+qs.n+'&2jSB='+qs.o+'&-Zu8='+qs.p+'&e9iH='+qs.q+'&b5ho='+qs.r+'&GAa8='+qs.a+'&DH5k='+qs.s+'&8rSZ='+qs.t+'&-Z06='+qs.u+'&m9kT=img';
	var moat_src = 
'https://js.moatads.com/audiencesquareappnexus107864036450/moatad.js#moatClientLevel1='+qs.x+'&moatClientLevel2='+qs.y+'&moatClientLevel3='+qs.z+'&moatClientLevel4='+qs.h+'&moatClientSlicer1='+qs.a1;
	var forensiq_src = 'https://c.fqtag.com/tag/implement.js?org=prazusW5kesewanapreg&fmt=banner&s='+qs.n+'&rd='+qs.a1+'&p=1608&a='+qs.f+'&cmp='+qs.z+'&c1='+qs.b+'&c2='+qs.h+'&c3='+qs.q+'&c4='+qs.a+'&ctu=&rt=display&sl=1&apn=1';
