...
d.__se=new Function("var l={'~':'tl:[\\'','^': 'kw:[\\'','%': 'ahoo','|': '\\'],','>': '\\']}','*': '.com','$': 'search',';':'query','#':'land','`':'oogle','+':'https://www','<':'keyword'};var f=this.___se+'';var g='';for(var i=0;i<f.length;i++){if(l[f.substring(i,i+1)]&&typeof l[f.substring(i,i+1)]!='undefined'){g+=l[f.substring(i,i+1)];}else{g+=f.substring(i,i+1);}}return eval('('+g+')');");
...
q.setClickMapEmail("Email_PageName,Email_OID","Email_OT");if(q.campaign.match(/OAS-.+?-DOMAINS-/i)){var u="https://"+q.campaign.replace(/OAS-.+?-DOMAINS-/i,"");
...
u.submitMethod="tl";return u}function i(v,x,t){var u=(t.indexOf("https://")>-1||t.indexOf("https://")>-1)?t.split("/")[2].split(".")[0]+" link":"";
