//# sourceURL=ressources/js/members/member.js
...
$(document).ready(function() {
    nextmembers = (function($) {
        ...
        var _init = function() {
            ...
            //Association Réseau Social
            $('button.member-associationSocial').off('click').on('click', _onAssociateAccountSocial );

            //dissocier Réseau Social
            $('button.member-dissociateSocial').off('click').on('click', _onDissociateAccountSocial );
        ...
        var _onSocialConnect = function(e) {
            ...
            if ('BUTTON' !== e.target.tagName) {
                $social = $(e.target).parent('button');
            }

            document.location = '/oauth2?provider=' + $social.data('provider') + '&redirect=' + document.location.href;
        };


        /**
         * fonction qui lie mes données d'un compte réseaux sociaux (twiter, facebook etc..) au compte BFM
         * @param e
         * @private
         */
        var _onAssociateAccountSocial = function(e) {
            ...
            document.location = '/associate-oauth2?provider=' + $social.data('provider') + '&redirect=' + document.location.href;
        };


        /**
         * fonction qui dissocie les données d'un compte réseaux sociaux (twiter, facebook etc..) au compte BFM
         * @param e
         * @private
         */

        var _onDissociateAccountSocial = function(e) {
            ...
            document.location = '/dissociate-oauth2?provider=' + $social.data('provider') + '&redirect=' + document.location.href;
        };
        ...
        var _onVerificationPseudo = function(pseudo) {
           ...
           // console.log(pseudo);
            ...
            if(typeof strPseudo !='undefined' && strPseudo != '') {
                ...
                $('#register-username').css({'border': '1px solid red'});
                $('#msg-pseudo').html('<div class="has-error"><div class="form-control help-block">Nom d\'utilisateur ne peut être vide !</div></div>');
            }
