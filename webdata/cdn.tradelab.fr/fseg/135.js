...
if ( typeof tldc.funnelSegments['135'] == 'undefined' ) {
	tldc.funnelSegments['135'] = [];
	var n=0;
	tldc.funnelSegments['135'][n++] = { 'seg':'2119547', 	'step':1, 'ievs':'2119544', 'conv':'371475' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2119548', 	'step':2, 'ievs':'2119545', 'conv':'371476' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2119549', 	'step':3, 'ievs':'2119546', 'conv':'371477' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327189', 	'step':4, 'ievs':'2342241', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327190', 	'step':5, 'ievs':'2342244', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327191', 	'step':6, 'ievs':'2342312', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327192', 	'step':7, 'ievs':'2342314', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327193', 	'step':8, 'ievs':'2342316', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327146', 	'step':10, 'ievs':'2509022', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327147', 	'step':9, 'ievs':'2509021', 'conv':'0' };
	tldc.funnelSegments['135'][n++] = { 'seg':'2327143', 	'step':11, 'ievs':'2509025', 'conv':'0' };
...
for (var i = 0; i < scriptTags.length; i++) {
  ...
  if (undefined !== ssrc && null !== ssrc && ssrc.indexOf('fseg') !== -1 && ssrc.indexOf('135.js') !== -1) {  	
    ...
    //console.log('tlfseg:'+JSON.stringify(tldc.tlfseg));
    	if ( typeof tldc.tlfseg[qs.add] === 'undefined' ) {	    		  		
    		if ( processFunnelSeg(qs.add,'135',tldc.funnelSegments['135']) ) tldc.tlfseg[qs.add] = 1;  
    	}
    }
  }
}
