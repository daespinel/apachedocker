/* 2015-08-25 17:12:26 */
var x14=true;var x1k,x15,x1fN,x1m,x1D,x1J,x1n,x1mG,x1j3,x1n6,x1x,adperf_present,x1h=navigator.appVersion.toLowerCase(),x1qy=navigator.userAgent,x19=x1qy.toLowerCase(),x1n7,x1n8,x1oi;var x1jG,x1jH,x1fE,x1jI,x1jJ,x1jK,x1mF={};var adperf_version='1.0.0';var x1C;var weborama_display_tag,adperfobj=(weborama_display_tag&&!weborama_display_tag.x1sa&&weborama_display_tag)||adperfobj||{};adperfobj.x1sa=true;function x1I(){if('javas'+String()+'cript:'===document.location.protocol){return'https:'===parent.document.location.protocol;}
...
return x1cM;}
function x1nE(x1ne){x1ne=x1ne||{};var x1n9=x1I(),x1jV,x1qz=x1ne.cachebuster===false?'':'?r='+Math.random();x1fN=x1ne.mediapath||'';var x1qA='_scrambled.js';x15='https://cstatic.weborama.fr/js/advertiserv2/';x1m='https://'+(x1ne.fullhost||(x1ne.host+'.solution.weborama.fr'))+'/fcgi-bin/dispatch.fcgi';x1J=x15+'adperf_launch_'+adperf_version+x1qA;x1D=x1ne.admire_id?"":x1m;x1j3="";x1jV=x15+'adperf_core_'+adperf_version+x1qA;x1n=x15+'adperf_debug_'+adperf_version+x1qA;x1mG=x15+'adperf_adapter_'+adperf_version+x1qA;x1J=x1Q(x1J,x1n9);x1n=x1Q(x1n,x1n9);x1mG=x1Q(x1mG,x1n9);x1D=x1Q(x1D,x1n9);x1m=x1Q(x1m,x1n9);x15=x1Q(x15,x1n9);x1fN=x1Q(x1fN,x1n9);x1j3=x1Q(x1j3,x1n9);}
function x1S(x1x){if((typeof x1x!=='undefined')&&(x1x!=='')&&(x1x!=='undefined')&&(x1x!=='null')&&(x1x!==null)&&(x1x!==false)){return true;}
return false;}
function x1o_(x1nr){if(typeof x1nr==='string'){return!!x1nr.match(/^([a-z]+:)?\/\//i);}
return false;}
function x1pJ(x1nr){if(typeof x1nr==='string'&&!x1nr.match(/^[a-z]+:/i)){return x1Q('http:'+x1nr,x1I());}
return x1nr;}
...
return x1gm;}
function x1q6(x1cM){if(typeof x1cM==='string'&&!x1cM.match(/^https?%3A/)){x1cM=escape(x1cM);}
return x1cM;}
function x1q7(x1cM){if(typeof x1cM==='string'&&x1cM.match(/^https?%3A/)){x1cM=unescape(x1cM);}
return x1cM;}
function x1sb(x1sc,x1sd){x1sc=x1sc||x1O;x1sd=x1sd||top;var x1se=x1sd===x1sc;return{x1nq:function(x1dK,x1nr){x1dK=x1dK.replace(/[\|\[]/,"\\[").replace(/[\]]/,"\\]");var x1ns,x1nt,x1nu="[\\?&]"+x1dK+"=([^&#]*)";x1nt=new RegExp(x1nu);x1ns=x1nt.exec(x1nr||x1sc.location.href);if(x1S(x1ns)){return x1ns[1];}
return'';},x1nv:function(){var x1cF='';if(!x1se){try{x1cF=decodeURIComponent(this.x1nq('publisherclick'));}catch(x1o){}
if(x1cF.length>10&&x1o_(x1cF)){return x1cF;}
try{x1cF=decodeURIComponent(this.x1nq('pubclick'));}catch(x1b_){}
if(x1cF.length>10&&x1o_(x1cF)){return x1cF;}
}
return false;},x1sf:function(x1gv,x1nt,x1sg,x1sh){x1sh=x1sh===undefined?true:x1sh;if(!x1se){for(var x1dK in x1gv){var x1cF=this.x1nq(x1gv[x1dK]);var x1si=x1sh===x1nt.test(x1cF);if(x1cF.length>0&&x1si){return x1cF;}
}
}
return x1sg;},x1nx:function(){return this.x1sf(['random','rand'],/[{\[%$#@\(].*[\]}%$#@\)]/,false,false);},x1qB:function(){return this.x1sf(['device_id'],/[a-f0-9_\-]+/i,false);},x1af:function(){return this.x1sf(['burst'],/^[a-zA-Z]+$/,false);},x1ag:function(){return this.x1sf(['bursttarget'],/^[a-zA-Z\.]+$/,false);},x1ah:function(){return this.x1sf(['bursttype'],/^[a-zA-Z]+$/,false);},x1ai:function(){return this.x1sf(['burstpath'],/^[a-zA-Z0-9_\-\.\\\/]+$/,false);},x1n0:function(){return this.x1sf(['customparameter','customid'],/^[a-zA-Z0-9_\-\.\\\/]+$/,undefined);},x1n_:function(){if(!x1se){var x1cF=this.x1nq('donottrack');if(x1cF==='true'||x1cF==='1'){return true;}
if(x1cF==='false'||x1cF==='0'){return false;}
}
return undefined;},x1oa:function(){if(!x1se){var x1cF=this.x1nq('restrict');if(x1cF==='true'||x1cF==='1'){return true;}
if(x1cF==='false'||x1cF==='0'){return false;}
}
return undefined;},x1ob:function(){if(!x1se){var x1cF=this.x1nq('weakencoding');if(x1cF==='true'||x1cF==='1'){return true;}
if(x1cF==='false'||x1cF==='0'){return false;}
}
return undefined;}
};}
var x1np=x1np||x1sb(self,top);function x1u(){return(Math.ceil(Math.random()*99999999999));}
...
function x1k7(){var x1fD=location.host,x1pg,x1aP;if(!x1fD&&'javas'+String()+'cript:'===document.location.protocol){x1fD=parent.location.host;}
...
if((x1fE.length>=7)&&(x1fE.substr(0,7)==='https://')){x1jI=x1fE.substr(7);x1jJ='https://';}else if((x1fE.length>=8)&&(x1fE.substr(0,8)==='https://')){x1jI=x1fE.substr(8);x1jJ='https://';}
...
x1sn=!!window.ScriptEngineMajorVersion&&x1qy.indexOf(' Edge/')>0&&parseFloat(x1qy.match(/ Edge\/([\d\.]+)/)[1])||false;x1y=(x19.indexOf('msie')!==-1&&!x1T)?parseFloat(x19.slice(x19.indexOf('msie')+5)):(x19.indexOf('trident')!==-1?parseFloat(x19.slice(x19.indexOf('rv:')+3)):0);x1t=(x19.indexOf('gecko')!==-1&&!x1T&&!x1y)?parseFloat(x19.slice(x19.indexOf('rv:')+3)):0;x1_=(x19.indexOf('applewebkit')>=0&&(!(x1T&&x1e>2&&x1e<4)))?parseFloat(x19.slice(x19.indexOf('applewebkit')+12)):0;x11=(x1_>0&&x19.indexOf('chrome')<0&&x19.indexOf('android')===-1);x1l=(!x11&&(x1_>0&&x19.indexOf('chrome')!==-1))?parseInt(x19.match(/chrome\/(\d+)\./)[1],10):0;if(x1e&&x1F&&x1y){x1e=x1F=x1H=x1t=x1_=x1P=x1U=false;}
if(self.opera!==undefined&&self.opera.version!==undefined){x1T=self.opera.version();x1t=x1_=x1y=0;}
x1oh=(typeof(window.ScriptEngineMajorVersion)==='function')&&window.ScriptEngineMajorVersion()>5?window.ScriptEngineMajorVersion():document.documentMode?8:x1y;x1A=(x1y>=7&&document.documentMode!==undefined)?document.documentMode:(x1sn?x1oh:false);if(x1sn){x1_=x1t=x1l=false;x1y=x1oh;}
x1pN=x1qy.indexOf(' Xbox')!==-1;x1ao=!!((x1e&&((x1_&&x19.indexOf('mobile safari')===-1)||x19.indexOf('tablet')!==-1))||x1G||(!x1pN&&x1qC&&x1qy.indexOf(' ARM;')!==-1));x1R=!!((x1e&&(x19.indexOf('mobile')!==-1||x19.indexOf('opera mobi')!==-1))||(x19.indexOf('iphone')>=0)||(x19.indexOf('symbian')>=0)||(x19.indexOf('opera mini')>=0)||(x19.indexOf('windows ce')>=0)||(x19.indexOf('iemobile')>=0));if(x1oh>=10&&!x1sn&&x1R===false){try{x1lM=new ActiveXObject('htmlfile');x1lM=!x1lM;}catch(x1o){x1lM=true;}
}
...
if(!x1S(adperfobj.admire_id)){adperfobj.admire_id=false;}
...
(function(){var x1x;for(x1x=0;x1x<adperfobj.landing_urls.length;x1x++){adperfobj.landing_urls[x1x]=x1q6(adperfobj.landing_urls[x1x]);}
...
var screenad=screenad||{};screenad.campaignfreq=screenad.flightfreq=0;var adperf_burst=adperfobj.burst;var x1p=(typeof adperf_present==='undefined'||adperf_present.indexOf(adperf_version+':')<0)?true:false;if(x1p){var x1O=self,x1N=x1O.document,x1P,x1U,x1ba,x1qC,x1K,x1e,x1F,x1og,x1T,x1t,x1_,x11,x1l,x1y,x1A,x1lM,x1oh,x1sn,x1H,x1G,x1ao,x1R,x1pN,x1q=0,x1s,x1ok=false,x1lh=false,x1aj='',x1i,x1V;x1C=[];if(x1y&&x1y<11){if(x1y>=6){try{x1i=new ActiveXObject('ShockwaveFlash.ShockwaveFlash');x1i.AllowScriptAccess='always';x1aj=x1i.GetVariable('$version').replace(/[a-zA-Z]/g,'');x1q=parseInt(x1aj,10);x1s=parseInt(x1aj.split(',')[2],10);}catch(x1o){x1lh=true;}
}
...
};}());if(x1j()===false&&!x1S(adperfobj.nosetupscript)&&!x1aQ()){var x1E;if(x1d.x1rn){x1E=x1D+'/i/?id={scr:admireid}'+'&ci={scr:customid}'+'&ho={scr:hostname}'+'&pl={scr:placement}'+'&fl={scr:flash}'+'&sw={scr:swidth}'+'&sh={scr:sheight}'+'&rt={scr:returntype}'+'&dnt={scr:donottrack}'+'&rn={scr:random}'+'&ca={scr:cachebuster}';x1E=x1d.x1gV(x1E,[['{scr:returntype}',((x14)?'s':'p')]]);if(x14){x1aR(x1E);}else{x1M(x1E);}
}
else{x1E=x1D+'?a.A=im&a.si='+x1d.x1lr+'&a.te='+x1d.x1ls+'&a.ra={scr:random}'+'&a.agi={scr:actiongroupid}'+'&g.de={scr:previewmode}'+'&ca={scr:cachebuster}'+'&a.hr=js'+'&a.wi={scr:width}'+'&a.he={scr:height}'+'&a.sh={scr:sheight}'+'&a.sw={scr:swidth}'+'&a.ycp={scr:customid}'+'&g.ism={scr:useinapptracking}'+'&g.dnt={scr:donottrack}'+'&g.did={scr:deviceid}'+'&a.we='+(x1d.x1lL?1:0)+(adperfobj.publisherclick?'&a.pc='+escape(adperfobj.publisherclick):'')+(adperfobj.restrict?'&g.rst=1':'')+(adperfobj.price_paid?'&g.rtbpp='+parseFloat(adperfobj.price_paid):'')+(adperfobj.bid_price?'&g.rtbbp='+parseFloat(adperfobj.bid_price):'')+'&g.pu='+x1jH+'&g.ru='+x1jG;x1E=x1d.x1gV(x1E);if(x1E.length>8000){try{x1E=(x1E.split('g.ru='))[0];if(x1E.length>8000){x1E=(x1E.split('g.pu='))[0];}
}catch(x1o){}
}
x1aR(x1E);}
(function(){var x1an=adperfobj.imptrackers,x1x;for(x1x=0;x1x<x1an.length;x1x++){x1d.x1eC(x1an[x1x],false,true);}
adperfobj.imptrackers=[];}());if(x1d.x1rn){if(typeof inDapMgrIf!=='undefined'){x1j3+='?='+x1u();}
x1aR(x1j3);}
}
}
